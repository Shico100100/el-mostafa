  ...
  return (
    <div className="flex flex-wrap items-center gap-3 p-4 glass rounded-2xl border border-white/5 mb-6">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-blue-500/10 hover:bg-blue-500/20 text-blue-200 rounded-xl text-sm font-medium transition border border-blue-500/20"
      >
      ...
      <div className="flex items-center gap-2 mr-auto">
        ...
        <input
          ...
          className="bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-slate-200 focus:outline-none focus:border-blue-500/50 transition"
        />
      </div>

      <div className="text-xs text-slate-500 bg-white/5 px-3 py-1.5 rounded-lg">
