export function FloatingOrbs() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      <div className="absolute top-[10%] left-[5%] w-72 h-72 bg-blue-500/4 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
      <div className="absolute top-[40%] right-[10%] w-96 h-96 bg-purple-500/4 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '12s' }} />
