...
export function DashboardPageContent() {
  ...
  return (
    <div className="min-h-screen text-[#ecfdf5]" dir="rtl">
      <FloatingOrbs />
        ...
        <div className="container mx-auto px-6 py-2.5 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="w-9 h-9 bg-gradient-to-br from-emerald-500 via-blue-600 to-purple-700 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/30 ring-1 ring-blue-400/20">
            ...
            <div>
              <h1 className="text-sm font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-200 via-emerald-100 to-purple-200">
                نظام المصطفى
              </h1>
          ...
          <div className="flex items-center gap-1.5">
            <LiveClock />
            <button onClick={refresh} title="تحديث البيانات" className="p-1.5 text-[#ecfdf5]0 hover:text-blue-400 hover:bg-emerald-500/10 rounded-lg transition">
            ...
            <NotificationBell />
              ...
              <button onClick={() => router.push('/dashboard/control-tower')}
                className="px-2.5 py-1.5 bg-gradient-to-r from-indigo-600/20 to-teal-500/10 hover:from-teal-500/30 hover:to-indigo-400/20 text-indigo-300 rounded-xl text-[11px] transition border border-teal-500/20 flex items-center gap-1.5">
                <Radar />
              </button>
            <div className="w-px h-5 bg-white/5 mx-1" />
            <button onClick={handleLogout}
              className="p-1.5 text-[#ecfdf5]0 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition" title="تسجيل الخروج">
      ...
      <main className="relative container mx-auto px-6 pt-5 pb-12">
        <div className="relative mb-8 overflow-hidden rounded-3xl bg-gradient-to-br from-slate-800/60 via-slate-800/40 to-slate-900/60 border border-white/5 p-6 md:p-8">
          ...
          <div className="relative">
            ...
            <p className="text-sm text-[#ecfdf5]0 mr-4 mb-5">
                ...
                {summaryCards.map((card) => (
                  <div key={card.label}
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-[10px] text-[#ecfdf5]0 mt-0.5 truncate">{card.label}</p>
                    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8">
          <div className="lg:col-span-2 bg-slate-800/30 backdrop-blur-xl rounded-2xl border border-white/5 p-5 hover:border-white/10 transition-all duration-300">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-1 h-5 bg-gradient-to-b from-emerald-500 to-cyan-400 rounded-full" />
