...
import { productTypeLabel } from '@/components/inventory/types';
import type { TypeStats } from '@/hooks/inventory/useInventoryDashboard';
        ...
        {typeStats.map((stat) => {
          ...
          return (
            <button key={stat.type}
              onClick={() => router.push(`/inventory/products?type=${stat.type}`)}
