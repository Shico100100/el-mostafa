...
export default function PageLayout({ title, subtitle, backHref, actions, children, noContainer }: PageLayoutProps) {
  ...
  return (
    <>
      ...
      {noContainer ? children : <main className="page-container">{children}</main>}
    </>
  );
}
