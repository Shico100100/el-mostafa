        ...
        <form onSubmit={onSave} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <input className="w-full p-2.5 bg-white/5 border border-white/10 rounded-xl text-white focus:border-blue-500/50 transition outline-none"
          ...
          <div className="space-y-1">
            ...
            <input type="email" className="w-full p-2.5 bg-white/5 border border-white/10 rounded-xl text-white focus:border-blue-500/50 transition outline-none"
          ...
          <div className="space-y-1">
            ...
            <input type="password" className="w-full p-2.5 bg-white/5 border border-white/10 rounded-xl text-white focus:border-blue-500/50 transition outline-none"
          ...
          <div className="space-y-1">
            ...
            <select className="w-full p-2.5 bg-slate-800 border border-white/10 rounded-xl text-white focus:border-blue-500/50 transition outline-none"
          ...
          <div className="flex gap-3 justify-end mt-8">
            ...
            <button type="submit" className="px-8 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold transition shadow-lg shadow-blue-500/20">حفظ</button>
          </div>
        </form>
      </div>
    </div>
