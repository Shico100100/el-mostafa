...
import { MovementsSummary } from '@/components/inventory/movements/MovementsSummary';
import { MovementsFilters } from '@/components/inventory/movements/MovementsFilters';
import { MovementItem } from '@/components/inventory/movements/MovementItem';
...
export default function MovementsPage() {
  ...
  return (
    <>
      <MovementsHeader onBack={() => router.push('/inventory/stock')} onRefresh={h.loadData} />
