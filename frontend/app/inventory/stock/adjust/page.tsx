...
import { useAdjust } from '@/hooks/inventory/useAdjust';
import { AdjustHeader } from '@/components/inventory/adjust/AdjustHeader';
import { AdjustForm } from '@/components/inventory/adjust/AdjustForm';
...
export default function AdjustPage() {
  ...
  return (
    <>
      <AdjustHeader onBack={() => router.push('/inventory/stock')} />
      <div className="px-8 py-8 max-w-2xl mx-auto">
        <AdjustForm products={h.products} warehouses={h.warehouses}
          ...
          onSubmit={h.handleSubmit} onCancel={() => router.push('/inventory/stock')} />
      </div>
    </>
  );
}
