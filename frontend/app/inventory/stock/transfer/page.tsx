...
import { useTransfer } from '@/hooks/inventory/useTransfer';
import { TransferHeader } from '@/components/inventory/transfer/TransferHeader';
import { TransferForm } from '@/components/inventory/transfer/TransferForm';
...
export default function TransferPage() {
  ...
  return (
    <>
      <TransferHeader onBack={() => router.push('/inventory/stock')} />
      <div className="px-8 py-8 max-w-2xl mx-auto">
        <TransferForm products={h.products} warehouses={h.warehouses}
          ...
          onCancel={() => router.push('/inventory/stock')} />
      </div>
    </>
  );
}
