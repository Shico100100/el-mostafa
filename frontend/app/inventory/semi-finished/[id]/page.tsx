...
interface CostBreakdown {
    ...
    electricityPerMachineHour: number;
    electricityHourly: number;
    machineDepreciationHourly: number;
    machineHourly: number;
    hoursWorked: number;
    estimatedPieces: number;
    fixedPerPiece: number;
    moldAmortizationPerPiece: number;
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-md lg:col-span-2">
                        <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                            💰 تحليل التكلفة
                                ...
                                {/* Fixed + Electricity + Depreciation Cost */}
                                <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                                    <h3 className="text-lg font-bold text-blue-300 mb-2">2. التكاليف الثابتة والكهرباء والإهلاك</h3>
                                    <div className="text-gray-300 text-sm space-y-1">
                                ...
                                {costBreakdown.moldAmortizationPerPiece > 0 && (
                                    <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                                        <h3 className="text-lg font-bold text-purple-300 mb-2">3. إهلاك القالب</h3>
                                        <div className="text-gray-300 text-sm space-y-1">
                                ...
                                <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                                    <h3 className="text-lg font-bold text-green-300 mb-2">{costBreakdown.moldAmortizationPerPiece > 0 ? '4' : '3'}. إجمالي التكلفة التقديرية للقطعة</h3>
