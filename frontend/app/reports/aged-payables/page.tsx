    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0f0d] via-[#0f1714] to-[#0a0f0d]" dir="rtl">
      <div className="container mx-auto px-6 py-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-white flex items-center gap-3"><Building2 className="w-8 h-8 text-teal-400" />الحسابات الدائنة المتأخرة</h1>
          {h.agedPayables.length > 0 && <button onClick={() => exportElementToPdf('aged-payables-content', 'aged-payables')} className="bg-teal-600/20 hover:bg-teal-600/30 text-teal-300 px-4 py-2 rounded-lg border border-teal-500/30 transition flex items-center gap-2"><FileDown className="w-4 h-4" />تصدير PDF</button>}
        </div>

        <div id="aged-payables-content" className="p-6 bg-[#0a0f0d] rounded-xl">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {h.agedPayables.length === 0 ? (
                    <tr><td colSpan={6} className="py-12 text-center text-[#6b8378]">لا توجد حسابات دائنة</td></tr>
