...
const aliasMap: Record<string, string> = {
  ...
  '/api/v1/manufacturing/production-schedules': '/api/v1/manufacturing/planning',
  '/api/v1/manufacturing/quality-control': '/api/v1/manufacturing/qc/recent',
  ...
  '/api/v1/employee-profiles': '/api/v1/payroll/profiles',
