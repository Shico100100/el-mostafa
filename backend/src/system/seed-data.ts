...
export async function seedDemoData(dataSource: DataSource) {
  ...
  try {
    ...
    await insertIgnore(queryRunner, 'user', [
      { id: 3, email: 'manager@admin.com', password: managerPassword, provider: 'email', firstName: 'Manager', lastName: 'Account', roleId: 3, statusId: 1 },
      { id: 4, email: 'worker@admin.com', password: workerPassword, provider: 'email', firstName: 'Worker', lastName: 'Account', roleId: 6, statusId: 1 },
      { id: 5, email: 'viewer@admin.com', password: viewerPassword, provider: 'email', firstName: 'Viewer', lastName: 'Account', roleId: 7, statusId: 1 },
    ]);
    logger.log('Role-based users seeded');
