...
describe('InventoryService', () => {
  ...
  const mockQueryRunner = {
    ...
    manager: {
      ...
      save: jest
        .fn()
        .mockImplementation((entity, data) => ({ id: 1, ...data })),
      findOne: jest.fn(),
      delete: jest.fn(),
      update: jest.fn(),
    },
      ...
      providers: [
        ...
        },
        {
          ...
          useValue: {
            getAllCategories: jest
              .fn()
              .mockResolvedValue([{ id: 1, name: 'Raw' }]),
        ...
        },
        {
          ...
          useValue: {
            ...
            findOne: jest
              .fn()
              .mockResolvedValue({ id: 1, name: 'Test Product', sku: 'SKU1' }),
            create: jest.fn(),
            save: jest.fn(),
            update: jest.fn(),
            delete: jest.fn(),
  ...
  describe('createProduct', () => {
    ...
    it('should rollback transaction on error', async () => {
      (transactionHelper.runInTransaction as jest.Mock).mockRejectedValueOnce(
        new Error('DB error'),
      );
  ...
  describe('addStockMovement', () => {
    it('should delegate to stockService.addStockMovement with correct params', async () => {
      ...
      (stockService.addStockMovement as jest.Mock).mockResolvedValue(
        mockResult,
      );
